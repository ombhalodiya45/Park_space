                        ...
                        <div className="w-full md:w-auto">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full md:w-80 lg:w-96 pl-10 pr-3 py-2 rounded-lg border border-gray-300 bg-white
                       text-sm sm:text-base focus:ring-2 focus:ring-blue-200 focus:border-blue-600 outline-none"
                                />
                            </div>
                        </div>
                    </div>
                            ...
                            {filtered.map((slot) => (
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        onClick={() => navigate(`/book/${slot.customCode}`)}
